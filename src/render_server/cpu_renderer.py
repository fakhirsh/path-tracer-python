...
class CpuRenderer(BaseRenderer):
    """CPU-based renderer implementation (reference implementation)"""

    def render(self, enable_preview=True):
        """
        CPU rendering implementation.
        TODO: Add multiprocessing/threading for parallel rendering.
        For now, uses the simple single-threaded render loop.
